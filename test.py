...
# Datasets
parser.add_argument('--dataset', type=str, default='FGSCR')
...
parser.add_argument('--resume', type=str, default='result/FGSCR/R/global_1.0_local_0.1/best_model.pth.tar')
# FewShot settting
...
parser.add_argument('--nTestNovel', type=int, default=5,
...
def main():
    ...
    args.resume = osp.join(args.save_dir, 'best_model.pth.tar')  # 设置恢复训练的模型路径
